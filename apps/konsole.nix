        ...
        configFile = {
          "konsolerc" = {
            ...
            "MainWindow" = {
              ...
              "State".value =
                "";
            };
          };
        };
